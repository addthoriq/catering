...
<html lang="id">
  ...
  <head>
    ...
    <title>Akun Admin | Ilma Catering Samarinda</title>
    <!-- Favicons-->
            ...
            <div id="striped-table">
              <div class="row">
                ...
                <div class="col s6 m6 l6" style="margin-top: 15px;">
                  <a class="waves-effect waves-light btn right" href="baru.php"><i class="material-icons right">add</i>Tambah</a>
                </div>
              </div>
                    ...
                    if (mysqli_num_rows($res)>0) {
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <a class="btn-floating waves-effect waves-light red lighten-1" href="delete.php?id=<?= $row['id'] ?>" onclick='javascript:return confirm("Apakah anda yakin ingin menghapus data ini?")'><i class="material-icons left">delete</i> butqton</a>
                        </td>
                      </tr>
                      <?php
                        ;
