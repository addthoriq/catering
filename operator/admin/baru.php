...
<html lang="id">
  ...
  <head>
    ...
    <title>Buat Admin | Ilma Catering Samarinda</title>
    <!-- Favicons-->
        ...
        <section id="content">
          ...
          <div class="container">
            <div id="striped-table">
              <div class="row">
                <div class="col s12">
                  <h4 class="header"><a class="waves-effect" href="index.php">Menu Admin</a></h4>
                </div>
              </div>
            </div>
            <!--Basic Form-->
              <div class="card-panel">
                ...
                <div class="row">
                  <form class="col s12" action="proses_baru.php" method="POST" enctype="multipart/form-data">
                    <div class="row">
