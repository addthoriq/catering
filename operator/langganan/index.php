...
<html lang="id">
  ...
  <head>
    ...
    <title>Menu Langganan | Ilma Catering Samarinda</title>
    <!-- Favicons-->
                ...
                <div class="row">
                  ...
                  if (mysqli_num_rows($res)>0) {
                   ...
                   <tr>
                     ...
                     <td>
                       <a class="btn-floating waves-effect waves-light pink lighten-1" href="delete.php?id=<?= $row['id'] ?>" onclick='javascript:return confirm("Apakah anda yakin ingin menghapus data ini?")'><i class="material-icons left">delete</i> button</a>
                     </td>
                   </tr>
                   <?php
                     ;
