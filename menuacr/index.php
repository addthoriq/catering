          ...
          <div class="col s12 m6 l6">
            <div class="card">
              <div class="card-image">
                <img src="../adminmt/images/gallary/6.png">
                <span class="card-title">Katering Acara</span>
              </div>
              <div class="card-content">
                <p>Bikin acara yang berkesan buat semua orang itu sulit. Butuh rencana acara yang matang dan makanan yang enak biar semua orang tetap senang selama acara. Ilma Catering bantu menyajikan makanan yang enak buat tamu acaramu. Kualitas makanan terbaik dan porsi yang mengenyangkan dijamin meninggalkan kesan menyenangkan buat semua tamu kamu!</p>
              </div>
            </div>
          </div>
